...
class GANFairInpainter:
    def __init__(self):
        ...
        # Infer mask from low-energy regions
        self.mask = (self.magnitude_norm > -0.95).float()
        
        self.input_mag = self.magnitude_norm
        self.real_mag = self.magnitude_norm
        
        # Load original audio as ground truth for training
    ...
    def train(self, epochs=1000):
        ...
        print(f"⚔️ GAN is repairing damaged file ({epochs} epochs)...")
        ...
        with torch.no_grad():
            ...
            stft_recon = torch.polar(final.squeeze(0), self.phase)
    ...
    def save_result(self):
        ...
        print("💾 GAN restoration complete (fixed_gan_gap.wav + png)")
